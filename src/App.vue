  ...
  <div id="app">
    ...
    <nav v-if="isLoggedIn && isAdmin" class="navbar navbar-admin">
      ...
      <div class="nav-links">
        ...
        <router-link to="/admin/dashboard" class="nav-link">Báo cáo</router-link>
      </div>
      <div class="nav-right">
...
async function loadCartCount() {
  ...
  try {
    ...
    cartCount.value = Array.isArray(data) ? data.reduce((s, i) => s + i.quantity, 0) : 0
...
.navbar-admin { background: #1e2329; }
.navbar-user  { background: #fff; }
.brand { font-size: 15px; font-weight: 700; margin-right: 8px; }
.navbar-admin .brand { color: #facc15; }
.navbar-user  .brand { color: #1a73e8; }
.nav-links { display: flex; gap: 4px; flex: 1; }
.nav-link {
  padding: 7px 14px; border-radius: 7px;
  text-decoration: none; font-size: 13.5px; font-weight: 500;
}
.navbar-admin .nav-link { color: #9ca3af; }
.navbar-admin .nav-link:hover,
.navbar-admin .nav-link.router-link-active { background: #374151; color: #fff; }
.navbar-user .nav-link { color: #5f6368; }
.navbar-user .nav-link:hover { background: #f1f3f4; }
.navbar-user .nav-link.router-link-active { background: #e8f0fe; color: #1a73e8; }
.nav-right { display: flex; align-items: center; gap: 10px; }
.user-email { font-size: 13px; }
.navbar-admin .user-email { color: #9ca3af; }
.navbar-user  .user-email { color: #5f6368; }
...
.cart-btn:hover { background: #e8f0fe; color: #1a73e8; }
.cart-badge {
...
.navbar-admin .btn-logout { color: #9ca3af; border-color: #374151; }
.navbar-admin .btn-logout:hover { background: #374151; color: #fff; }
.navbar-user  .btn-logout { color: #5f6368; }
.navbar-user  .btn-logout:hover { background: #fce8e6; color: #ea4335; }
main.has-navbar { padding-top: 56px; }
</style>